...
<?php //require 'landingPage.php';  ?>

  <?php //} else {
    if($page =='arogya-supreme'){
        $header_icon="ArogyaSupreme_head.svg";
        $bottom_icon="inner-banner-bottom-icon.svg";
    }else if($page =='bharat-griha-raksha'){
      $header_icon="BharatGrihaRaksha_head.svg";
      $bottom_icon="living.svg";
    }else{
      $header_icon="retail-head-icon.svg";
      $bottom_icon="inner-banner-bottom-icon.svg";
    }
     ?>
...
<section class="container-with-no-padding container">
      <div class="innerpageBanner row">
        <div class="col-4">
          <figure class="justify-content-between align-items-center argyaBaner"><img src="<?php echo $asset_path;?>/images/<?php echo $header_icon;?>" alt="Arogya Sanjeevani Policy"></figure>
        </div>
        ...
        <div class="innerHeadBotomIcon"><img src="<?php echo $asset_path;?>/images/<?php echo $bottom_icon;?>" alt="Arogya Sanjeevani Policy"></div>
      </div>
    </section>

    <?php if(!empty($productStickyName)) { ?>
...
curl_close($ch);
$res = json_decode($productArr);
//echo '<pre>22';print_r($res[0]->filedata);die;
