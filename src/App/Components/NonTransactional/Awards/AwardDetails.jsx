...
class BoardOfDirectorDetails extends Component {
  ...
  getPageContent = () => {
    let pageSlug = this.state.pageSlug;
    Axios({
      method: "get",
      url: "/awards?slug=" + pageSlug
    })
      .then(res => {
        this.setState({
          pageData: res.data,
  ...
  render() {
    ...
    return (
      <>
        {/* <Helmet> */}
        <HelmetData pageComponentType="AwardDetails" />
                  ...
                  <div className="bod-details">
                    <div className="profile-block clerfix">
                      <figure className="profile-image">
                        {pageData[0].featured_image && pageData[0].featured_image.url ? (
                          <img src={AppConstant.IMG_BASE_URL + pageData[0].featured_image.url} alt={pageData[0].title} />
                        ) : null}
                      </figure>
