                      ...
                      />
                                ...
                                <div className="col-7 d-flex align-items-center">
                                    <div className="flex-column">
                                        <h3 className="banTitle">{this.state.productNameData} <span>Policy Details</span></h3>
                                        {/* For Desktop */}
                                    </div>
                    ...
                    <Container>
                        ...
                        <div className="tabWrap mt-5">
                            <Tab.Container id="left-tabs-example" defaultActiveKey="Agents">
                                <Row>
                                    <Col sm={12}>
                                        <h5 className="htitle centerText">Please choose your Language</h5>                                          
                                        <ul className="languageList">
                                        {languageDetails.map((item) => (
                                        <li className=""><a href={appUrl+"/product-features/"+this.props.match.params.productname+'/'+item.tag}>{item.language}</a></li>       
                                        ))}
