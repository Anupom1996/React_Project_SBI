...
class HomeWhySBI extends Component {
  ...
  render() {
    ...
    let title, over, description, sixcrore, Locations_New,Customers_served, SBI_network, branches,Location_Across_New, Network_Hospitals,  Text_11000;
    if (lang_name==='hi') {
      Locations_New = sbiHomeData && sbiHomeData['HOME_BLOG_350_NEW'] && sbiHomeData['HOME_BLOG_350_NEW'].content_hi;
      
      Text_11000 = sbiHomeData && sbiHomeData['HOME_BLOG_1100_TEXT'] && sbiHomeData['HOME_BLOG_1100_TEXT'].content_hi;
      Location_Across_New = sbiHomeData && sbiHomeData['HOME_BLOG_LOCATION_ACROSS_INDIA_NEW'] && sbiHomeData['HOME_BLOG_LOCATION_ACROSS_INDIA_NEW'].content_hi;
      ...
      Text_11000 = sbiHomeData && sbiHomeData['HOME_BLOG_1100_TEXT'] && sbiHomeData['HOME_BLOG_1100_TEXT'].content_en;
      Location_Across_New = sbiHomeData && sbiHomeData['HOME_BLOG_LOCATION_ACROSS_INDIA_NEW'] && sbiHomeData['HOME_BLOG_LOCATION_ACROSS_INDIA_NEW'].content_en;
      Locations_New = sbiHomeData && sbiHomeData['HOME_BLOG_350_NEW'] && sbiHomeData['HOME_BLOG_350_NEW'].content_en;
              ...
              <Row>
                ...
                <Col sm="4">
                  <div className="hLineMobile hcinfo align-items-center d-flex pb-5">
                    ...
                    <div className="pl-2">
                    {Text_11000?ReactHtmlParser(Text_11000): ReactHtmlParser('<strong className="d-block inrs"><i class="fas fa-rupee-sign"></i>11000 Crore</strong><span className="text-black d-block">Claims handled worth over</span>')}
                    {/* {ReactHtmlParser(Location_Across_New)} */}
                      {/* <span className="text-black d-block">
                ...
                <Col sm="4">
                  <div className="hLineMobile bigtxt align-items-center d-flex">
                    ...
                    {Location_Across_New?ReactHtmlParser(Location_Across_New): ReactHtmlParser('<strong className="pl-3 pr-3">125 </strong> Locations across India')}
                     {/* {ReactHtmlParser(Location_Across_New)} */}
                ...
                <Col sm="4">
                  <div className="hLineMobile bigtxt align-items-center d-flex">
                    ...
                    <div className="pl-2">
                    {Locations_New?ReactHtmlParser(Locations_New): ReactHtmlParser('<span className="text-black d-block">Satellite Presence in</span> <strong> 350+</strong> locations')}
                   
                    {/* {ReactHtmlParser(Locations_New)} */}
