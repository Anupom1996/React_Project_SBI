...
class PublicLiabilityAct extends Component {
  render() {
    let sbiHomeData = localStorage.getItem("phrases") ? JSON.parse(localStorage.getItem("phrases")) : null;
    let lang_name = localStorage.getItem("lang_name") ? localStorage.getItem("lang_name") : 'en';
    let key_feature, Coverage, locate_us, Exclusion, Liability_Insurance_Policy, Public_Liability_Feature,
      Public_Liability_Coverage, Public_Liability_Exclusion, Heading_Mobile_Version
    ...
    if (lang_name === 'en') {
      ...
      Liability_Insurance_Policy = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC'].content_en;
      Public_Liability_Feature = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_FEATURE'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_FEATURE'].content_en;
      Public_Liability_Coverage = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_COVERAGE'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_COVERAGE'].content_en;
      Public_Liability_Exclusion = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_EXCLUSION'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_EXCLUSION'].content_en;
      ...
      Liability_Insurance_Policy = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC'].content_hi;
      Public_Liability_Feature = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_FEATURE'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_FEATURE'].content_hi;
      Public_Liability_Coverage = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_COVERAGE'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_COVERAGE'].content_hi;
      Public_Liability_Exclusion = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_EXCLUSION'] && sbiHomeData['PRODUCTS_LIABILITY_PUBLIC_LIABLITY_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="PublicLiabilityAct" />
          {isMobile ? (
            <section className="topform product-header">
              <div className="insuTab">
                <h1>{Liability_Insurance_Policy}</h1>
                ...
                <Tab.Container defaultActiveKey="tabmain_1">
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="tabmain_1">
                      ...
                      >
                        {ReactHtmlParser(Public_Liability_Feature)}
                    ...
                    <Tab.Pane eventKey="tabmain_2">
                      ...
                      <Scrollbars
                        ...
                        className="bg-dark-scroll"
                      >
                        {ReactHtmlParser(Public_Liability_Coverage)}
                    ...
                    <Tab.Pane eventKey="tabmain_3">
                      ...
                      >
                        ...
                        {ReactHtmlParser(Public_Liability_Exclusion)}
...
export default PublicLiabilityAct;
