...
class WeProtectYouResources extends Component {
    ...
    constructor(props) {
        ...
        //     console.log("data", this.state.productRelatedData.related_data);
    ...
    getDownloadContent = () => {
        ...
        Axios({
            method: "get",
            url: "/productdetailtranslations?language_eq=" + lang_name + "&Name_eq=WeProtectYouResourcesData",
            ...
            .then(res => {
                    ...
                    for (let j = 0; j < filedata.length; j++) {
                        if (this.props.productType === 'personal-accident-insurance') {
                            if ('individual-pa-insurance' === filedata[j].key) {
                                ...
                                this.setState({
                                    productRelatedData: filedata[j].related_data,
                                    showLoader: true,
                ...
                if (this.state.productRelatedData && this.state.productRelatedData.length > 6) {
                ...
                <Col xs="12" lg="8" className="weProtect">
                    ...
                    <div className="weProtectSub color-purple">
                        {this.state.productData &&
                            ...
                            this.state.productRelatedData.length > 0 ?
                            (
                                this.state.obj && this.state.obj.length > 0 ?
                                    ...
                                    (<ul className="d-flex flex-wrap">
                                        <>
                                            ...
                                            {this.state.productRelatedData.map(
                                                (item, index) => (
                                                    <li key={index}>
                                                        <figure className="justify-content-between align-items-center">
