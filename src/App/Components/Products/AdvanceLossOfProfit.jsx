...
class AdvanceLossOfProfit extends Component {
  ...
  gtmClickHandler = (click_text) => {
    ...
    const data = {
      'event': 'advance_lossof_profit_product_page_4_product_features_click',
      'product_name': 'Advance Loss of Profit',
      'pagetype': 'advance_lossof_profit_product_page',
      'client_id': gaUserId,
  ...
  render() {
    ...
    if (lang_name==='en') {   
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_ADVANCE_POLICY'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_ADVANCE_POLICY'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_EXCLUSION'].content_en;
     
     
        
  } else {       
    Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_hi;
    Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_ADVANCE_POLICY'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_ADVANCE_POLICY'].content_hi;
   ...
   Exclusion = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_EXCLUSION'] && sbiHomeData['PRODUCTS_RETAIL_EXCLUSION'].content_hi;
    ...
    Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_FEATURE'].content_hi;
    Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_COVERAGE'].content_hi;
    
    Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_ADVANCE_LOSS_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="AdvanceLossOfProfit" />
          {isMobile ? (
...
export default AdvanceLossOfProfit;
