...
class FidelityGuarantee extends Component {
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_FIDELITY'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_FIDELITY'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_EXCLUSION'].content_en;



    } else {
      Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_hi;
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_FIDELITY'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_FIDELITY'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_COVERAGE'].content_hi;

      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_FIDELITY_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="FidelityGuarantee" />
          {isMobile ? (
