...
class MotorTradeTransitRisk extends Component {

  render() {
    let sbiHomeData = localStorage.getItem("phrases") ? JSON.parse(localStorage.getItem("phrases")) : null;
    let lang_name = localStorage.getItem("lang_name") ? localStorage.getItem("lang_name") : 'en';
    let key_feature, Coverage, locate_us, Exclusion, Motor_Trade_Road, Comprehensive_Cover, form_cover, Loss_destruction_damage, Any_liabilities, cover_Insurance, Legal_Liability,
      Liability_compensation, Compulsory_Personal_Accident, Loss_or_damage,
      Policy_covers_against_loss, Natural_Calamities, Fire_explosion, Manmade_Calamities, Burglary_theft, Additional_covers,
      Additional_Legal_liabilities, Heading_Mobile,additional_liabilities, Paid_driver, Employees_travelling, Bifuel_Kit, CNG_LPG_bifuel, Branch,
      Any_loss_damage, Normal_wear_tear, Depreciation_consequential, Mechanical_breakdown, Vehicle_used, Damage_by_person, Third_Pirty_Libality,
      Damage_person_driving, liquor, Loss_damage_war, Failures_breakage, Damage_accessories, Insured_stolen, Garage1, Liability_Cover;
    ...
    if (lang_name === 'en') {
      ...
      Motor_Trade_Road = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TRADE_ROAD'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TRADE_ROAD'].content_en;
      ...
      Heading_Mobile = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_HEADING'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_HEADING'].content_en;
      ...
      Loss_or_damage = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT4'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT4'].content_en;
      Policy_covers_against_loss = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT5'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT5'].content_en;
      Natural_Calamities = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT6'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT6'].content_en;
      Fire_explosion = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT7'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT7'].content_en;
      Manmade_Calamities = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT8'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT8'].content_en;
      Burglary_theft = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT9'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT9'].content_en;
      ...
      Bifuel_Kit = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT15'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT15'].content_en;
      CNG_LPG_bifuel = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT16'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT16'].content_en;
      ...
      Damage_accessories = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT27'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT27'].content_en;
      Insured_stolen = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT28'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT28'].content_en;
      Garage1 = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_TEXT31'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_TEXT31'].content_en;
      ...
      Motor_Trade_Road = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TRADE_ROAD'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TRADE_ROAD'].content_hi;
      ...
      Loss_or_damage = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT4'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT4'].content_hi;
      Policy_covers_against_loss = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT5'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT5'].content_hi;
      Natural_Calamities = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT6'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT6'].content_hi;
      Fire_explosion = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT7'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT7'].content_hi;
      Manmade_Calamities = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT8'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT8'].content_hi;
      Burglary_theft = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT9'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT9'].content_hi;
      ...
      Bifuel_Kit = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT15'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT15'].content_hi;
      CNG_LPG_bifuel = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT16'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT16'].content_hi;
      ...
      Damage_accessories = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT27'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT27'].content_hi;
      Insured_stolen = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT28'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_TEXT28'].content_hi;
      Garage1 = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_TEXT31'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_TEXT31'].content_hi;
      ...
      Heading_Mobile = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_HEADING'] && sbiHomeData['PRODUCTS_CORPORATE_MOTOR_RISK_HEADING'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="MotorTradeTransitRisk" />
          {isMobile ? (
            <section className="topform product-header motor-product-header">
              <div className="insuTab">
                <h1>{Motor_Trade_Road}</h1>
                  ...
                  <Tab.Content>
                    ...
                    <Tab.Pane eventKey="tabmain_2">
                      ...
                      >
                        ...
                        <p>
                          <strong>{Loss_or_damage}</strong>{Policy_covers_against_loss}{" "}
                        </p>
                        <p>
                          <strong>{Natural_Calamities} </strong> {Fire_explosion}{" "}
                        </p>
                        <p>
                          <strong>{Manmade_Calamities}</strong> {Burglary_theft}{" "}
                        </p>
                        <p>{Additional_covers}</p>
                        <p> {Additional_Legal_liabilities} </p>
                        <ul>
                          <li>
                            {additional_liabilities}  </li>
                          <li>
                            {Paid_driver}
                          </li>
                          <li>
...
export default MotorTradeTransitRisk;
