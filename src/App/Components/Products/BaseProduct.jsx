...
class BaseProduct extends Component {
  ...
  render() {
    ...
    let Sbi_General,Banner_Big_Text,Banner_Small_Text,Products,Retail,Corporate,Rural,Liability
    ;
   
    if (lang_name==='en') {
      
      
      Sbi_General = sbiHomeData && sbiHomeData['PRODUCTS_BANNER_SBI_GENERAL'] && sbiHomeData['PRODUCTS_BANNER_SBI_GENERAL'].content_en;
      Retail = sbiHomeData && sbiHomeData['PRODUCTS_TAB_RETAIL'] && sbiHomeData['PRODUCTS_TAB_RETAIL'].content_en;
      Liability = sbiHomeData && sbiHomeData['PRODUCTS_TAB_LIABILITY'] && sbiHomeData['PRODUCTS_TAB_LIABILITY'].content_en;
      Rural = sbiHomeData && sbiHomeData['PRODUCTS_TAB_RURAL'] && sbiHomeData['PRODUCTS_TAB_RURAL'].content_en;
      Corporate = sbiHomeData && sbiHomeData['PRODUCTS_TAB_CORPORATE'] && sbiHomeData['PRODUCTS_TAB_CORPORATE'].content_en;
      Products = sbiHomeData && sbiHomeData['PRODUCTS_HEADING_PRODUCTS'] && sbiHomeData['PRODUCTS_HEADING_PRODUCTS'].content_en;
      Banner_Small_Text = sbiHomeData && sbiHomeData['PRODUCTS_BANNER_SMALL_TEXT'] && sbiHomeData['PRODUCTS_BANNER_SMALL_TEXT'].content_en;
      Banner_Big_Text= sbiHomeData && sbiHomeData['PRODUCTS_BANNER_BIG_TEXT'] && sbiHomeData['PRODUCTS_BANNER_BIG_TEXT'].content_en;
     
   
   
  } else {
    
    Sbi_General = sbiHomeData && sbiHomeData['PRODUCTS_BANNER_SBI_GENERAL'] && sbiHomeData['PRODUCTS_BANNER_SBI_GENERAL'].content_hi;
    Retail = sbiHomeData && sbiHomeData['PRODUCTS_TAB_RETAIL'] && sbiHomeData['PRODUCTS_TAB_RETAIL'].content_hi;
    Liability = sbiHomeData && sbiHomeData['PRODUCTS_TAB_LIABILITY'] && sbiHomeData['PRODUCTS_TAB_LIABILITY'].content_hi;
    Rural = sbiHomeData && sbiHomeData['PRODUCTS_TAB_RURAL'] && sbiHomeData['PRODUCTS_TAB_RURAL'].content_hi;
    Corporate = sbiHomeData && sbiHomeData['PRODUCTS_TAB_CORPORATE'] && sbiHomeData['PRODUCTS_TAB_CORPORATE'].content_hi;
    Products = sbiHomeData && sbiHomeData['PRODUCTS_HEADING_PRODUCTS'] && sbiHomeData['PRODUCTS_HEADING_PRODUCTS'].content_hi;
    Banner_Small_Text = sbiHomeData && sbiHomeData['PRODUCTS_BANNER_SMALL_TEXT'] && sbiHomeData['PRODUCTS_BANNER_SMALL_TEXT'].content_hi;
    Banner_Big_Text = sbiHomeData && sbiHomeData['PRODUCTS_BANNER_BIG_TEXT'] && sbiHomeData['PRODUCTS_BANNER_BIG_TEXT'].content_hi;
   
  }
  console.log("path::" ,sbiHomeData);
    return (
      <BaseComponent>
