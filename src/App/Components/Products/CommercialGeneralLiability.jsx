...
class CommercialGeneralLiability extends Component {

  gtmClickHandler = (click_text) => {
    //GTM Implementation
    let gaUserId = document.cookie.match(/_ga=(.+?);/)[1].split('.').slice(-2).join(".");
    const data = {
      'event': 'commercial_general_liability_product_page_4_product_features_click',
      'product_name': 'Commercial General Liability',
      'pagetype': 'commercial_general_liability_product_page',
      'client_id': gaUserId,
  ...
  render() {
    ...
    let key_feature, Coverage, locate_us, Exclusion, Commercial_Liability, LIABILITY_COMMERCIAL_FEATURE,
      LIABILITY_COMMERCIAL_COVERAGE, LIABILITY_COMMERCIAL_EXCLUSION, Heading_Mobile_Version
    ...
    if (lang_name === 'en') {
      ...
      Commercial_Liability = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL'] &&
        sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL'].content_en;
      LIABILITY_COMMERCIAL_FEATURE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_FEATURE']
        && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_FEATURE'].content_en;
      LIABILITY_COMMERCIAL_COVERAGE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_COVERAGE']
        && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_COVERAGE'].content_en;
      LIABILITY_COMMERCIAL_EXCLUSION = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_EXCLUSION']
        && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_EXCLUSION'].content_en;
      ...
      LIABILITY_COMMERCIAL_FEATURE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_FEATURE']
        && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_FEATURE'].content_hi;
      LIABILITY_COMMERCIAL_COVERAGE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_COVERAGE']
        && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_COVERAGE'].content_hi;
      LIABILITY_COMMERCIAL_EXCLUSION = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_EXCLUSION']
        && sbiHomeData['PRODUCTS_LIABILITY_COMMERCIAL_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="CommercialGeneralLiability" />
          {isMobile ? (
            <section className="topform product-header">
              <div className="insuTab">
                <h1>{Commercial_Liability} </h1>
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="tabmain_1">
                      ...
                      >
                        ...
                        {ReactHtmlParser(LIABILITY_COMMERCIAL_FEATURE)}
                    ...
                    <Tab.Pane eventKey="tabmain_2">
                      ...
                      >
                        ...
                        {ReactHtmlParser(LIABILITY_COMMERCIAL_COVERAGE)}
                    ...
                    <Tab.Pane eventKey="tabmain_3">
                      ...
                      >
                        ...
                        {ReactHtmlParser(LIABILITY_COMMERCIAL_EXCLUSION)}
