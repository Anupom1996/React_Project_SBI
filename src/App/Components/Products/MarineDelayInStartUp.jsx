...
class MarineDelayInStartUp extends Component {
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_DELAY'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_DELAY'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_DELAY_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_DELAY_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_DELAY_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_DELAY_COVERAGE'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_DELAY'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_DELAY'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_DELAY_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_DELAY_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_DELAY_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_DELAY_COVERAGE'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="MarineDelayInStartUp" />
          {isMobile ? (
...
export default MarineDelayInStartUp;
