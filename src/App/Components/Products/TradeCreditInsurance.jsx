...
class TradeCreditInsurance extends Component {
  ...
  render() {
    ...
    if (lang_name==='en') {   
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_TRADE_CREDIT'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_TRADE_CREDIT'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_EXCLUSION'].content_en;
     
     
        
  } else {       
    Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_hi;
    Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_TRADE_CREDIT'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_TRADE_CREDIT'].content_hi;
   ...
   Exclusion = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_EXCLUSION'] && sbiHomeData['PRODUCTS_RETAIL_EXCLUSION'].content_hi;
    ...
    Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_FEATURE'].content_hi;
    Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_COVERAGE'].content_hi;
    
    Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_TRADE_CREDIT_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="TradeCreditInsurance" />
          {isMobile ? (
            <section className="topform product-header">
              <div className="insuTab">
                ...
                <div className="healgth-list">
                  <ul>
                    <li>
                      Trade receivables are a vital ingredient of any
                      organisation’s balance sheet. Delay in payment of debt or
                      insolvency of buyers can make a serious impact on the
                      organisation’s financial health.
                    </li>
                    <li>
                      SBI General presents Trade Credit Insurance to make you
                      certain in the uncertain markets{" "}
                    </li>
                  </ul>
                </div>
                {/* For Mobule */}
...
export default TradeCreditInsurance;
