...
class ClinicalTrialProfessionalLiability extends Component {

  gtmClickHandler = (click_text) => {
    //GTM Implementation
    let gaUserId = document.cookie.match(/_ga=(.+?);/)[1].split('.').slice(-2).join(".");
    const data = {
      'event': 'clinical_trial_professional_liability_product_page_4_product_features_click',
      'product_name': 'Clinical Trial (Professional liability)',
      'pagetype': 'clinical_trial_professional_liability_product_page',
      'client_id': gaUserId,
  ...
  render() {
    ...
    let key_feature, Coverage, locate_us, Exclusion, Clinical_Trial_Liability, CLINICAL_PROFESSIONAL_FEATURE,
      CLINICAL_PROFESSIONAL_EXCLUSION, CLINICAL_PROFESSIONAL_COVERAGE, Heading_Mobile
    ...
    if (lang_name === 'en') {
      ...
      Clinical_Trial_Liability = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_TRIAL'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_TRIAL'].content_en;
      CLINICAL_PROFESSIONAL_FEATURE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_FEATURE'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_FEATURE'].content_en;
      CLINICAL_PROFESSIONAL_COVERAGE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_COVERAGE'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_COVERAGE'].content_en;
      CLINICAL_PROFESSIONAL_EXCLUSION = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_EXCLUSION'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_EXCLUSION'].content_en;
      ...
      Clinical_Trial_Liability = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_TRIAL'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_TRIAL'].content_hi;
      CLINICAL_PROFESSIONAL_FEATURE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_FEATURE'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_FEATURE'].content_hi;
      CLINICAL_PROFESSIONAL_COVERAGE = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_COVERAGE'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_COVERAGE'].content_hi;
      CLINICAL_PROFESSIONAL_EXCLUSION = sbiHomeData && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_EXCLUSION'] && sbiHomeData['PRODUCTS_LIABILITY_CLINICAL_PROFESSIONAL_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="ClinicalTrialProfessionalLiability" />
          {isMobile ? (
            <section className="topform product-header motor-product-header">
              <div className="insuTab">
                <h1>{Clinical_Trial_Liability}</h1>
                ...
                <Tab.Container defaultActiveKey="tabmain_1">
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="tabmain_1">
                      ...
                      >
                        {ReactHtmlParser(CLINICAL_PROFESSIONAL_FEATURE)}
                    ...
                    <Tab.Pane eventKey="tabmain_2">
                      ...
                      <Scrollbars
                        ...
                        className="bg-dark-scroll"
                      >
                        {ReactHtmlParser(CLINICAL_PROFESSIONAL_COVERAGE)}
                      </Scrollbars>
                    </Tab.Pane>
                    <Tab.Pane eventKey="tabmain_3">
                      ...
                      <Scrollbars
                        ...
                        className="bg-dark-scroll"
                      >
                        {ReactHtmlParser(CLINICAL_PROFESSIONAL_EXCLUSION)}
...
export default ClinicalTrialProfessionalLiability;
