...
class CellularNetwork extends Component {
  ...
  gtmClickHandler = (click_text) => {
    ...
    const data = {
      'event': 'cellular_network_product_page_4_product_features_click',
      'product_name': 'Cellular Network',
      'pagetype': 'cellular_network_product_page',
      'client_id': gaUserId,
  ...
  render() {
    ...
    let Heading, Key_Feature, Coverage, Feature_Description,
      Coverage_Description, Footer, Heading_Mobile
      ;
    if (lang_name === 'en') {

      Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_en;
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_CELLUAR'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_CELLUAR'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_COVERAGE'].content_en;
      // Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_EXCLUSION'].content_en;



    } else {
      Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_hi;
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_CELLUAR'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_CELLUAR'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_CELLULAR_COVERAGE'].content_hi;
      ...
      // Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="CellularNetwork" />
          {isMobile ? (
