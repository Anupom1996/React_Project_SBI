...
class BusinessPackageInsurance extends Component {

  gtmClickHandler = (click_text) => {
    //GTM Implementation
    let gaUserId = document.cookie.match(/_ga=(.+?);/)[1].split('.').slice(-2).join(".");
    const data = {
      'event': 'business_package_product_page_4_product_features_click',
      'product_name': 'Business Package Insurance',
      'pagetype': 'business_package_product_page',
      'client_id': gaUserId,
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_PACKAGE_BUSINESS_POLICY'] && sbiHomeData['PRODUCTS_CORPORATE_PACKAGE_BUSINESS_POLICY'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_EXCLUSION'].content_en;



    } else {
      Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_hi;
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_PACKAGE_BUSINESS_POLICY'] && sbiHomeData['PRODUCTS_CORPORATE_PACKAGE_BUSINESS_POLICY'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_COVERAGE'].content_hi;
      ...
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_BUSINESS_PACKAGE_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="BusinessPackageInsurance" />
          {isMobile ? (
...
export default BusinessPackageInsurance;
