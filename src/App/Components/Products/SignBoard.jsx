...
class SignBoard extends Component {
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_SIGN_BOARD'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_SIGN_BOARD'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_COVERAGE'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_SIGN_BOARD'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_SIGN_BOARD'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_SIGN_BOARD_COVERAGE'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="SignBoard" />
          {isMobile ? (
