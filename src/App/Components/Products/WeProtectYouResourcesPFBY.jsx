...
class WeProtectYouResourcesPFBY extends Component {
    ...
    getProductRelatedData = productType => {
        if (WeProtectYouResourcesData) {
            const weProtectYouData = WeProtectYouResourcesData;
        ...
        return (
            <>
                <Col xs="12" lg="8" className="weProtect">
                    <h5 className="htitle">We Protect Your Crop</h5>
...
export default withRouter(WeProtectYouResourcesPFBY);