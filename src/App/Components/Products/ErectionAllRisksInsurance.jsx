...
class ErectionAllRisksInsurance extends Component {
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EAR'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EAR'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ERRECTION_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_ERRECTION_FEATURE'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EAR'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EAR'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_ERRECTION_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_ERRECTION_FEATURE'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="ErectionAllRisksInsurance" />
          {isMobile ? (
...
export default ErectionAllRisksInsurance;
