...
class KidnapRansomExtortion extends Component {
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_KIDNAP'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_KIDNAP'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_EXCLUSION'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_KIDNAP'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_KIDNAP'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_COVERAGE'].content_hi;

      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_KIDNAP_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="KidnapRansomExtortion" />
          {isMobile ? (
                ...
                <Tab.Container defaultActiveKey="tabmain_1">
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="tabmain_1">
                      <Scrollbars autoHeight autoHeightMin={0} autoHeightMax={370} hideTracksWhenNotNeeded className="bg-dark-scroll">
...
export default KidnapRansomExtortion;