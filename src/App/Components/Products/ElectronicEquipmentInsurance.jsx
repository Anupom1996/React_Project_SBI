...
class ElectronicEquipmentInsurance extends Component {
  render() {

    let sbiHomeData = localStorage.getItem("phrases") ? JSON.parse(localStorage.getItem("phrases")) : null;
    let lang_name = localStorage.getItem("lang_name") ? localStorage.getItem("lang_name") : 'en';
    let Heading, Key_Feature, Coverage, Exclusion, Sum_Insured, Feature_Description, Sum_Insured_Description,
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EEI'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EEI'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_EET_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_EET_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_EET_EXCLUSION'].content_en;
      Sum_Insured_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_SUM_INSURED'] && sbiHomeData['PRODUCTS_CORPORATE_EET_SUM_INSURED'].content_en;


    } else {
      Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_hi;
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EEI'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_EEI'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_EET_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_EET_COVERAGE'].content_hi;
      ...
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_EET_EXCLUSION'].content_hi;
      Sum_Insured_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_EET_SUM_INSURED'] && sbiHomeData['PRODUCTS_CORPORATE_EET_SUM_INSURED'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="ElectronicEquipmentInsurance" />
          {isMobile ? (
