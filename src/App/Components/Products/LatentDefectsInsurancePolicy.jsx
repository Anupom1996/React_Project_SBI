...
class LatentDefectsInsurancePolicy extends Component {

  render() {

    let sbiHomeData = localStorage.getItem("phrases") ? JSON.parse(localStorage.getItem("phrases")) : null;
    let lang_name = localStorage.getItem("lang_name") ? localStorage.getItem("lang_name") : 'en';
    let Heading, Key_Feature, Coverage, Exclusion, General_Exclusion, Feature_Description, General_Exclusion_description,
      Coverage_Description, Exclusion_Description, Heading_Mobile_Version, Footer;

    if (lang_name === 'en') {

      Footer = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'] && sbiHomeData['PRODUCTS_RETAIL_FOOTER_TEXT'].content_en;
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_DEFECTS_POLICY'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_DEFECTS_POLICY'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OIL_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_OIL_EXCLUSION'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_LATENT_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_LATENT_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_LATENT_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_LATENT_EXCLUSION'].content_en;
      General_Exclusion_description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_LATENT_GENERAL_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_LATENT_GENERAL_EXCLUSION'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_DEFECTS_POLICY'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_DEFECTS_POLICY'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OIL_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_OIL_EXCLUSION'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_LATENT_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_LATENT_COVERAGE'].content_hi;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_LATENT_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_LATENT_EXCLUSION'].content_hi;
      General_Exclusion_description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_LATENT_GENERAL_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_LATENT_GENERAL_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="LatentDefectsInsurancePolicy" />
          {isMobile ? (
...
export default LatentDefectsInsurancePolicy;
