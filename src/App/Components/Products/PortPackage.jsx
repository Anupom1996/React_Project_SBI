...
class PortPackage extends Component {
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_PORT'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_PORT'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_COVERAGE'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_PORT'] && sbiHomeData['PRODUCTS_CORPORATE_OTHERS_PORT'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_PORT_PACKAGE_COVERAGE'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="PortPackage" />
          {isMobile ? (
