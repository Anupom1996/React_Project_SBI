...
class BoilerPressurePlantInsurance extends Component {

  gtmClickHandler = (click_text) => {
    //GTM Implementation
    let gaUserId = document.cookie.match(/_ga=(.+?);/)[1].split('.').slice(-2).join(".");
    const data = {
      'event': 'boiler_pressure_plant_product_page_4_product_features_click',
      'product_name': 'Boiler And Pressure Plant Insurance',
      'pagetype': 'boiler_pressure_plant_product_page',
      'client_id': gaUserId,
  ...
  render() {
    ...
    if (lang_name === 'en') {
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_BOILER'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_BOILER'].content_en;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BOILER_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_BOILER_FEATURE'].content_en;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BOILER_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_BOILER_COVERAGE'].content_en;
      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BOILER_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_BOILER_EXCLUSION'].content_en;
     ...
     Addons = sbiHomeData && sbiHomeData['PRODUCTS_RETAIL_ACT_ONLY_TEXT2'] && sbiHomeData['PRODUCTS_RETAIL_ACT_ONLY_TEXT2'].content_en;
      ...
      Heading = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_BOILER'] && sbiHomeData['PRODUCTS_CORPORATE_CONSTRUCTION_BOILER'].content_hi;
      ...
      Feature_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BOILER_FEATURE'] && sbiHomeData['PRODUCTS_CORPORATE_BOILER_FEATURE'].content_hi;
      Coverage_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BOILER_COVERAGE'] && sbiHomeData['PRODUCTS_CORPORATE_BOILER_COVERAGE'].content_hi;

      Exclusion_Description = sbiHomeData && sbiHomeData['PRODUCTS_CORPORATE_BOILER_EXCLUSION'] && sbiHomeData['PRODUCTS_CORPORATE_BOILER_EXCLUSION'].content_hi;
    ...
    return (
      <div>
        <BaseComponent>
          {/* <Helmet> */}
          <HelmetData pageComponentType="BoilerPressurePlantInsurance" />
          {isMobile ? (
...
export default BoilerPressurePlantInsurance;
