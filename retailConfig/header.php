...
$page = "";
	$ch = curl_init();
	$curlConfig = array(
		CURLOPT_URL            => "http://localhost:1337/translationkeywords?&_limit=2000",    
...
if($_REQUEST['lang']=='hi'){
	$helmetData = "http://localhost:1337/productdetailtranslations?language_eq=hi&Name_eq=helmetData";
	$productData = "http://localhost:1337/productdetailtranslations?language_eq=hi&Name_eq=productData";
	$productRequestCallbackData = "http://localhost:1337/productdetailtranslations?language_eq=hi&Name_eq=productRequestCallbackData";
	$WeProtectYouResourcesData = "http://localhost:1337/productdetailtranslations?language_eq=hi&Name_eq=WeProtectYouResourcesData";
	$productRelatedResourcesData = "http://localhost:1337/productdetailtranslations?language_eq=hi&Name_eq=productRelatedResourcesData";	
}else{
	$helmetData = "http://localhost:1337/productdetailtranslations?language_eq=en&Name_eq=helmetData";
	$productData = "http://localhost:1337/productdetailtranslations?language_eq=en&Name_eq=productData";
	$productRequestCallbackData = "http://localhost:1337/productdetailtranslations?language_eq=en&Name_eq=productRequestCallbackData";
	$WeProtectYouResourcesData = "http://localhost:1337/productdetailtranslations?language_eq=en&Name_eq=WeProtectYouResourcesData";
	$productRelatedResourcesData = "http://localhost:1337/productdetailtranslations?language_eq=en&Name_eq=productRelatedResourcesData";
}
...
if($pageGroup == "health" && empty($productName)){
  ...
  $metaKeyword = $metaDesc = $canonical= '';
}
