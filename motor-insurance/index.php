...
<section class="container-with-no-padding container">
      <div class="innerpageBanner row">
        <div class="col-4">
          <figure class="justify-content-between align-items-center argyaBaner"><img src="<?php echo $asset_path;?>/images/motor-banner.svg" alt="Motor Insurance Policy"></figure>
        </div>
        ...
        <div class="innerHeadBotomIcon"><img src="<?php echo $asset_path;?>/images/motor-right-side.svg" alt="Motor Insurance Policy"></div>
      </div>
    </section>
    ...
    foreach($relatedData as $rData){ ?>       	
              <div class="item">
                ...
                ?>
                  ...
                  onclick="gtmPdfHandler('<?php echo strip_tags($rData->label);?>')">
	                  	<figure>
	                  		<img src="<?php echo $asset_path;?>/images/<?php echo strip_tags($rData->resource_icon);?>" alt="<?php echo strip_tags($rData->label);?>">
	                  	</figure>
                 		<?php echo strip_tags($rData->label);?>
              		</a>
              	</div>
              </div>            
     	<?php } ?>
